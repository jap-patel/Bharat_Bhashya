...
import os
from GCP_conversion import convert 
import GCP_conversion
from google.cloud import speech

GCP_conversion.convert("bn-IN","en-IN")
...
# output_file = 'demo-bengali-english' + lang_code + ".txt"
...
# lang_code = "bn-IN"
# target_lang = "en"
# text_file = 'demo-bengali-english' + lang_code +".txt" #'demo.txt'
...
# output_file = 'demo-' + target_lang + ".txt"
# with open(output_file,'w',encoding="utf-8") as output:
